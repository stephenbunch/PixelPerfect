...
pixelPerfect.panelActions = function(){
    ...
    return {
        ...
        deleteFile: function(fileToDelete){
            ...
            if (!file) 
                return false;
            var userOverlayPath = this.getFirefoxProfileRootFolder() + 'extensions' + this.directorySeperator + 'pixelperfectplugin@openhouseconcepts.com' + this.directorySeperator + 'chrome' + this.directorySeperator + 'pixelperfect' + this.directorySeperator + 'content' + this.directorySeperator + 'user_overlays' + this.directorySeperator;
